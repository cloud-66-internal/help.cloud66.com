...
You can customize the database configuration on your servers using [CustomConfig](/{{ include.product }}/stack-management/custom-config.html). CustomConfig is available for MySQL, PostgreSQL, Redis and MongoDB.
