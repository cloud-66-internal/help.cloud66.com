...
{% include _inlines/AddOns/common/haproxy/haproxy_about-configuring-haproxy-v1.md  product = page.collection %}
{% include _inlines/AddOns/common/haproxy/haproxy_view-haproxy-stats-v1.md  product = page.collection %}
{% include _inlines/AddOns/common/haproxy/haproxy_configure-haproxy-to-use-internal-ips-v1.md  product = page.collection %}
{% include _inlines/AddOns/common/haproxy/haproxy_specify-an-haproxy-test-interval-v1.md  product = page.collection %}
{% include _inlines/AddOns/common/haproxy/haproxy_change-the-haproxy-endpoint-v1.md  product = page.collection %}
{% include _inlines/AddOns/common/haproxy/haproxy_about-configuring-haproxy-with-customconfig-v1.md  product = page.collection %}
{% include _inlines/AddOns/common/haproxy/haproxy_config-variables-v1.md  product = page.collection %}
{% include _inlines/AddOns/common/haproxy/haproxy_commit-haproxy-customconfig-v1.md  product = page.collection %}
{% include _inlines/AddOns/common/haproxy/haproxy_warning-v1.md  product = page.collection %}
{% include _inlines/AddOns/common/haproxy/haproxy_configuring-haproxy-for-maintenance-mode-v1.md  product = page.collection %}