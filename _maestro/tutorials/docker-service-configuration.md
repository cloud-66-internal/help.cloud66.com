...
<table class="table table-bordered table-striped table-small"> 
   <tbody> 
    ...
    <tr> 
     <td> <a href="{% if include.product == "skycap" %}/maestro/tutorials/scaling.html{% else %}/{{page.collection}}/tutorials/scaling.html{% endif %}">constraints</a> </td> 
     <td> Specifies <a href="{% if include.product == "skycap" %}/maestro/tutorials/scaling.html{% else %}/{{page.collection}}/tutorials/scaling.html{% endif %}">container amount</a> or <a href="/{{page.collection}}/stack-management/service-resources.html">resource</a> constraints for a service across the cluster. </td> 
    </tr> 
    <tr> 
    ...
    <tr> 
     <td> <a href="/{{page.collection}}/deployment/service-network-configuration.html#dns_behaviour">dns_behaviour</a> </td> 
    ...
    <tr> 
     <td> <a href="/{{page.collection}}/stack-management/service-lifecycle-management.html#health">health (CSv1)</a> </td> 
    ...
    <tr> 
     <td> <a href="/{{page.collection}}/stack-management/service-lifecycle-management.html#health">health (CSv2)</a> </td> 
    ...
    <tr> 
     <td> <a href="/{{page.collection}}/deployment/service-network-configuration.html#load_balancing">load_balancing</a> </td> 
    ...
    <tr> 
     <td> <a href="/{{page.collection}}/deployment/service-network-configuration.html#ports">ports</a> </td> 
    ...
    <tr> 
     <td> <a href="/{{page.collection}}/stack-management/service-lifecycle-management.html#pre_start">pre_start_signal</a> </td> 
    ...
    <tr> 
     <td> <a href="/{{page.collection}}/stack-management/service-lifecycle-management.html#pre_stop">pre_stop_sequence</a> </td> 
     <td> This is a stop sequence that is executed on your running containers before they are shut down. </td> 
    </tr> 
    <tr> 
     <td> <a href="/{{page.collection}}/stack-management/service-lifecycle-management.html#requires">requires</a> </td> 
     <td> Array of other defined service names that should be started before this service during build and deployment. </td> 
    </tr> 
    <tr> 
     <td> <a href="/{{page.collection}}/stack-management/service-lifecycle-management.html#restart">restart_on_deploy</a> <em>(default: true)</em> </td> 
     <td> Boolean value to indicate whether the containers of this service should be restarted during deployment. </td> 
    </tr> 
    <tr> 
     <td> <a href="/{{page.collection}}/stack-management/service-lifecycle-management.html#stop_grace">stop_grace</a> </td> 
    ...
    <tr> 
     <td> <a href="/{{page.collection}}/deployment/service-network-configuration.html#traffic_matches">traffic_matches</a> </td> 
