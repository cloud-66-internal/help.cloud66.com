...
Repeated visits within a short time period (more than 1,500 hits per minute from a single IP address) on any of the default open ports will be blocked by [ActiveProtect](/maestro/references/active-protect.html).
