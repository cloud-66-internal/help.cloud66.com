...
If you have yet to deploy your application in a production environment, you can deploy to a reasonably sized server and use [load testing](/{{ include.product }}/tutorials/1980-09-26-optimizing-performance.html) to determine your exact needs.
