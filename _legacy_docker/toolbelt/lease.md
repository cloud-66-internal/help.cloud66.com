...
<a name="1"></a>{% include _inlines/Toolbelt/common/lease/lease_temporary-lease-v1.md  product = product %}
<a name="2"></a>{% include _inlines/Toolbelt/common/lease/lease_usage-v1.md  product = product %}
<a name="3"></a>{% include _inlines/Toolbelt/common/lease/lease_parameters-v1.md  product = product %}
<a name="4"></a>{% include _inlines/Toolbelt/common/lease/lease_example-v1.md  product = product %}