...
<a name="1"></a>{% include _inlines/Databases/common/database-management/database-management_contents.md  product = product %}
<a name="2"></a>{% include _inlines/Databases/common/database-management/database-management_about-deploying-databases.md  product = product %}
<a name="3"></a>{% include _inlines/Databases/common/database-management/database-management_database-deployment-types.md  product = product %}
<a name="4"></a>{% include _inlines/Databases/common/database-management/database-management_no-database-external.md  product = product %}
<a name="5"></a>{% include _inlines/Databases/common/database-management/database-management_local-database.md  product = product %}
<a name="6"></a>{% include _inlines/Databases/common/database-management/database-management_dedicated-database.md  product = product %}
<a name="7"></a>{% include _inlines/Databases/common/database-management/database-management_upgrading-your-database.md  product = product %}
<a name="8"></a>{% include _inlines/Databases/common/database-management/database-management_control-your-rails-database-migrations.md  product = product %}
<a name="9"></a>{% include _inlines/Databases/common/database-management/database-management_customize-your-database-configuration.md  product = product %}
<a name="10"></a>{% include _inlines/Databases/common/database-management/database-management_warning.md  product = product %}
<a name="11"></a>{% include _inlines/Databases/common/database-management/database-management_database-customization-variables.md  product = product %}
<a name="12"></a>{% include _inlines/Databases/common/database-management/database-management_it-is-0-for-standalone-servers-1-f.md  product = product %}