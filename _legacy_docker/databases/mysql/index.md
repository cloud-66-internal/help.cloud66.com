...
layout: post
template: one-col
title: MySQL with Cloud 66 Docker
categories: Databases
lead: "Using MySQL on Cloud 66 for docker stacks"
legacy: true
...
<a href="#environment-variables"></a>{% include _inlines/Databases/common/common/env-vars-v1.md dbtype = dbtype %} 
