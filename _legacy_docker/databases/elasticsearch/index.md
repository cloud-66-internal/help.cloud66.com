...
layout: post
template: one-col
title: Elasticsearch with Cloud 66 Docker
categories: Databases
lead: "Using Elasticsearch on Cloud 66 for docker stacks"
legacy: true
...
{% include _inlines/Databases/common/elasticsearch/about-deploying-dbs-v1.md  product = page.collection %}
<a href="#features"></a>{% include _inlines/Databases/common/elasticsearch/features-v1.md  product = page.collection dbtype = dbtype %}
<a href="#database-deployment-types"></a>{% include _inlines/Databases/common/elasticsearch/deployment-types-v1.md  product = page.collection %}
