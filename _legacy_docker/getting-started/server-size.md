...
{% include _inlines/GettingStarted/common/server-size/server-size_when-deploying-your-stack-you-are-asked-to-spe-v1.md  product = page.collection %}
{% include _inlines/GettingStarted/common/server-size/server-size_under-powered-server-sizes-not-recommended-v1.md  product = page.collection %}
{% include _inlines/GettingStarted/common/server-size/server-size_amazon-web-services-v1.md  product = page.collection %}
{% include _inlines/GettingStarted/common/server-size/server-size_cloud-a-v1.md  product = page.collection %}
{% include _inlines/GettingStarted/common/server-size/server-size_digitalocean-v1.md  product = page.collection %}
{% include _inlines/GettingStarted/common/server-size/server-size_google-compute-engine-v1.md  product = page.collection %}
{% include _inlines/GettingStarted/common/server-size/server-size_microsoft-azure-v1.md  product = page.collection %}
{% include _inlines/GettingStarted/common/server-size/server-size_rackspace-v1.md  product = page.collection %}