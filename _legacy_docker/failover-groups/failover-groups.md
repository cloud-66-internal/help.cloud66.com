...
<a name="1"></a>{% include _inlines/FailoverGroups/common/failover-groups/failover-groups_what-is-a-failover-group--v1.md  product = product %}
<a name="2"></a>{% include _inlines/FailoverGroups/common/failover-groups/failover-groups_add-a-failover-group-v1.md  product = product %}
<a name="3"></a>{% include _inlines/FailoverGroups/common/failover-groups/failover-groups_notes-v1.md  product = product %}
<a name="4"></a>{% include _inlines/FailoverGroups/common/failover-groups/failover-groups_environment-variables-v1.md  product = product %}