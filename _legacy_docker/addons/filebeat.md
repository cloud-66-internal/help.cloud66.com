...
<a name="1"></a>{% include _inlines/AddOns/common/filebeat/filebeat_about-using-filebeat.md %}
<a name="2"></a>{% include _inlines/AddOns/common/filebeat/filebeat_add-filebeat-to-your-stack.md %}
<a name="3"></a>{% include _inlines/AddOns/common/filebeat/filebeat_note.md %}