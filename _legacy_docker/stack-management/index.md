...
layout: post
template: one-col
title:  "Stack Management with Docker"
categories: stack-management
lead: Mange your Cloud 66 Docker Stacks
legacy: true
permalink: /:collection/:categories/index.html
---

Cloud 66 Docker supports the following stack management features:
...
- [Service Pause & Resume](service-pause-resume.html)
- [Service Resources](service-resources.html)
- [Service Storage](service-storage.html)
- [Scaling](scaling.html)
- [Logging](logging.html)
- [LiveLogs](live-logs.html)
- [Stack Notifications](stack-notifications.html)
- [Applying Upgrades](applying-upgrades.html)
- [CustomConfig](custom-config.html)
- [CustomConfig Git](custom-git-repository.html)
