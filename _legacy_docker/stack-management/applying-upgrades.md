...
<a name="1"></a>{% include _inlines/StackManagement/common/applying-upgrades/applying-upgrades_contents.md %}
<a name="2"></a>{% include _inlines/StackManagement/common/applying-upgrades/applying-upgrades_cloud66-update-packages-policy.md %}
<a name="3"></a>{% include _inlines/StackManagement/common/applying-upgrades/applying-upgrades_tip.md %}
<a name="4"></a>{% include _inlines/StackManagement/common/applying-upgrades/applying-upgrades_upgrade-package-types.md %}
<a name="5"></a>{% include _inlines/StackManagement/common/applying-upgrades/applying-upgrades_security-updates.md %}
<a name="6"></a>{% include _inlines/StackManagement/common/applying-upgrades/applying-upgrades_ubuntu.md %}
<a name="7"></a>{% include _inlines/StackManagement/common/applying-upgrades/applying-upgrades_ruby.md %}
<a name="8"></a>{% include _inlines/StackManagement/common/applying-upgrades/applying-upgrades_scaling-up.md %}
<a name="9"></a>{% include _inlines/StackManagement/common/applying-upgrades/applying-upgrades_in-place-upgrades.md %}
<a name="10"></a>{% include _inlines/StackManagement/common/applying-upgrades/applying-upgrades_tip-.md %}
<a name="11"></a>{% include _inlines/StackManagement/common/applying-upgrades/applying-upgrades_building-a-new-stack.md %}
<a name="12"></a>{% include _inlines/StackManagement/common/applying-upgrades/applying-upgrades_rails.md %}
<a name="13"></a>{% include _inlines/StackManagement/common/applying-upgrades/applying-upgrades_passenger.md %}
<a name="14"></a>{% include _inlines/StackManagement/common/applying-upgrades/applying-upgrades_docker-and-weave.md %}
<a name="15"></a>{% include _inlines/StackManagement/common/applying-upgrades/applying-upgrades_about-manual-upgrades.md %}