...
layout: post
template: one-col
title:  "Using Addins with Docker"
categories: addins
lead: Addins for container stacks supported by Cloud 66 Docker
legacy: true
permalink: /:collection/:categories/index.html
---

Cloud 66 for Docker supports the following Add-ins features:
