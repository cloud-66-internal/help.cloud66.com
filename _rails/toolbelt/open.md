...
<a name="1"></a>{% include _inlines/Toolbelt/common/open/open_open-your-website-v1.md  product = page.collection %}
<a name="2"></a>{% include _inlines/Toolbelt/common/open/open_usage-v1.md  product = page.collection %}
<a name="3"></a>{% include _inlines/Toolbelt/common/open/open_parameters-v1.md  product = page.collection %}
<a name="4"></a>{% include _inlines/Toolbelt/common/open/open_example-v1.md  product = page.collection %}