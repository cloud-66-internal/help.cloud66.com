...
<a name="4"></a>{% include _inlines/Toolbelt/common/settings/settings_example-1.md %}
<a name="5"></a>{% include _inlines/Toolbelt/common/settings/settings_set-your-stack-settings.md %}
<a name="6"></a>{% include _inlines/Toolbelt/common/settings/settings_usage.md %}
<a name="7"></a>{% include _inlines/Toolbelt/common/settings/settings_parameters.md %}
<a name="8"></a>{% include _inlines/Toolbelt/common/settings/settings_example.md %}
<a name="9"></a>{% include _inlines/Toolbelt/common/settings/settings_settings-variables.md %}