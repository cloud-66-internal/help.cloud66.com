...
<img alt="Cloud 66 service diagram" src="/assets/rails/PaaS.png">
...
By default, your applications are served with Nginx, and you are also free to customize this selection for Rack-based applications. You can [scale your web server](/rails/how-to-guides/scaling/scaling.html) with the click of a button.


### Background workers (optional)

To relieve pressure from your application, we recommend that you use background workers to run memory-intensive processes. Cloud 66 makes it easy for you to control and monitor these processes, as well as [scale them](/rails/how-to-guides/deployment/proc-files.html) at the click of a button.
...
Cloud 66 makes it easy for you to [backup your database](/rails/how-to-guides/add-ins/database-backups.html), [verify the backup](/rails/how-to-guides/databases/backup-verifiers.html) and [replicate your databases](/rails/how-to-guides/databases/database-replication.html).
...
You can either [deploy to your preferred cloud provider](/rails/resources/technical-specifications.html#supported-cloud-providers) or [deploy to your own server](/rails/how-to-guides/deployment/registered-servers.html).
...
- The [Manifest file](/rails/quickstarts/getting-started-with-manifest.html) captures settings for infrastructural components in a simple YAML format, making it quick and easy to roll out additional instances of a component without any manual intervention
- [CustomConfig](/rails/tutorials/custom-config.html) gives you a powerful, version-controlled interface for customizing the configuration files for components like databases and Nginx
- [Deploy Hooks](/rails/tutorials/deploy-hooks.html) allow you to automate the customization of components during your build and deployment process - for example installing a custom package, or a series of packages that depend on one another.
