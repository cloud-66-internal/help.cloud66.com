...
<a name="1"></a>{% include _inlines/Tutorials/common/2013-01-20-whenever/2013-01-20-whenever_if-you-have-the-whenever-gemhttps-v1.md  product = page.collection %}
<a name="2"></a>{% include _inlines/Tutorials/common/2013-01-20-whenever/2013-01-20-whenever_note-1-v1.md  product = page.collection %}
<a name="3"></a>{% include _inlines/Tutorials/common/2013-01-20-whenever/2013-01-20-whenever_target-all-servers-v1.md  product = page.collection %}
<a name="4"></a>{% include _inlines/Tutorials/common/2013-01-20-whenever/2013-01-20-whenever_target-your-web-servers-v1.md  product = page.collection %}
<a name="5"></a>{% include _inlines/Tutorials/common/2013-01-20-whenever/2013-01-20-whenever_target-your-database-server-v1.md  product = page.collection %}
<a name="6"></a>{% include _inlines/Tutorials/common/2013-01-20-whenever/2013-01-20-whenever_target-your-redis-server-v1.md  product = page.collection %}
<a name="7"></a>{% include _inlines/Tutorials/common/2013-01-20-whenever/2013-01-20-whenever_target-the-first-server-in-a-server-gro-v1.md  product = page.collection %}
<a name="8"></a>{% include _inlines/Tutorials/common/2013-01-20-whenever/2013-01-20-whenever_note-v1.md  product = page.collection %}