...
<a name="1"></a>{% include _inlines/Deployment/common/cloud-do/cloud-do_contents.md  product = product %}
<a name="2"></a>{% include _inlines/Deployment/common/cloud-do/cloud-do_about-using-digitalocean-cloud.md  product = product %}
<a name="3"></a>{% include _inlines/Deployment/common/cloud-do/cloud-do_authorise-cloud-66-to-your-digitalocean.md  product = product %}
<a name="4"></a>{% include _inlines/Deployment/common/cloud-do/cloud-do_notice.md  product = product %}
<a name="5"></a>{% include _inlines/Deployment/common/cloud-do/cloud-do_external-links.md  product = product %}