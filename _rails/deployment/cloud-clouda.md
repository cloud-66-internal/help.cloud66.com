...
<a name="1"></a>{% include _inlines/Deployment/common/cloud-clouda/cloud-clouda_contents.md  product = product %}
<a name="2"></a>{% include _inlines/Deployment/common/cloud-clouda/cloud-clouda_about-using-cloud-a-cloud.md  product = product %}
<a name="3"></a>{% include _inlines/Deployment/common/cloud-clouda/cloud-clouda_adding-your-cloud-a-credentials.md  product = product %}
<a name="4"></a>{% include _inlines/Deployment/common/cloud-clouda/cloud-clouda_notice.md  product = product %}