...
{% include _inlines/StackManagement/common/live-logs/live-logs_what-is-livelogs-v1.md  product = page.collection %}
{% include _inlines/StackManagement/common/live-logs/live-logs_how-does-livelogs-work-v1.md  product = page.collection %}
{% include _inlines/StackManagement/common/live-logs/live-logs_how-do-i-use-livelogs-v1.md  product = page.collection %}
{% include _inlines/StackManagement/common/live-logs/live-logs_how-do-i-add-additional-logs-to-livelogs-v1.md  product = page.collection %}
{% include _inlines/StackManagement/common/live-logs/live-logs_note-v1.md  product = page.collection %}