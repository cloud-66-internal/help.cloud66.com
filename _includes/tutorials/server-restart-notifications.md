...
In order to minimise down-time, you can restart one server at a time (assuming you have a [load balancer](https://help.cloud66.com/{{page.collection}}/tutorials/load-balancing.html) in place). Selecting an out-of-hours time is recommended to minimise disruption. You can also use the [maintenance page](https://help.cloud66.com/{{page.collection}}/tutorials/service-network-configuration.html) to temporarily notify your users that you are performing maintenance.

To restart your server, it is recommended that you <a href="https://help.cloud66.com/{{page.collection}}/how-to-guides/deployment/shells/ssh.html">SSH to your server</a> and run either of the following terminal commands:
