...
<div class="notice">
  <h3>Note</h3><p>You can set the frequency and the number of rotations to be kept  <a href="/{{page.collection}}/references/shells/toolbelt.html#list-your-stack-settings">using toolbelt</a>.</p>
</div>
