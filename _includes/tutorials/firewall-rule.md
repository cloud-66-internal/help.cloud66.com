...
Imagine you need to SSH directly into your servers from an external IP address, and for whatever reason, you can't use the [Toolbelt](/{{page.collection}}/quickstarts/using-cloud66-toolbelt.html#access-your-servers-via-toolbelt) to do so.
