...
Cloud 66 Docker includes the following:
   ...
   {% if page.collection == "maestro" %}- [Storage layer](/maestro/how-to-guides/build-and-config/service-storage.html){% else %}- [Storage layer](/{{page.collection}}/how-to-guides/deployment/service-storage.html){% endif %}
...
Docker-based stacks enjoy the same benefits as other Cloud 66 stacks, including: 
   ...
   - [Firewall management and brute force protection for web and SSH]({% if page.collection == "maestro" %}/maestro/how-to-guides/build-and-config/service-network-configuration.html{% else %}/{{page.collection}}/tutorials/service-network-configuration.html{% endif %})
   ...
   - [Server vital sign metrics]({% if page.collection== 'skycap' %}/maestro/how-to-guides/build-and-config/setting-up-custom-livelogs.html{%else%}/{{page.collection}}/how-to-guides/deployment/setting-up-custom-livelogs.html{%endif%})
