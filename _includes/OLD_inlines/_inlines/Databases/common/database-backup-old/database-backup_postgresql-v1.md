...
{%include _inlines/Databases/common/database-backup/code_database-backup_postgresql-findpathto-v1.md  product = include.product %}
...
{%include _inlines/Databases/common/database-backup/code_database-backup_postgresql-findpathto-2-v1.md  product = include.product %}
...
{%include _inlines/Databases/common/database-backup/code_database-backup_postgresql-findpathto-2-3-v1.md  product = include.product %}
...
{%include _inlines/Databases/common/database-backup/code_database-backup_postgresql-gzipdpath-v1.md  product = include.product %}
...
{%include _inlines/Databases/common/database-backup/code_database-backup_postgresql-export-v1.md  product = include.product %}
