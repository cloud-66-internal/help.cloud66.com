...
{%include _inlines/AddIns/common/database-backups/code_database-backups_postgresql-findpathto-v1.md  product = include.product %}
...
{%include _inlines/AddIns/common/database-backups/code_database-backups_postgresql-findpathto-2-v1.md  product = include.product %}
...
{%include _inlines/AddIns/common/database-backups/code_database-backups_postgresql-findpathto-2-3-v1.md  product = include.product %}
...
{%include _inlines/AddIns/common/database-backups/code_database-backups_postgresql-gzipdpath-v1.md  product = include.product %}
...
{%include _inlines/AddIns/common/database-backups/code_database-backups_postgresql-export-v1.md  product = include.product %}
