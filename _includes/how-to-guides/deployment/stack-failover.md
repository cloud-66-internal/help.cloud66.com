...
3.  Make your [database replica a master](/{{page.collection}}/references/toolbelt/toolbelt-commands.html#databases-promote-replica) - this will allow data to be written to the database.
