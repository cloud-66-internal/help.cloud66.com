...
2.  [Clone your source stack](/{{ include.product }}/concepts/stack-definition.html) and deploy it to the new datacenter. This will save any environment variables you had configured on the source stack.
...
4.  Use our [one-time database import](/{{ include.product }}/chow-to-guides/deployment/shells/migrate-the-stack.html) feature to migrate your data across.
...
If you followed step 3a above, switch the target database from being a slave to a master (as outlined in the [database replication between stacks](/{{ include.product }}/how-to-guides/databases/shells/pg-replication-version.html) documentation).
