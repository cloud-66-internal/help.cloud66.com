...
#### Notice
<div class="notice notice-warning"><p>We do not support https:// for public repos. Please use http:// or git://</p></div>
{% endif %}

{% if include.product == 'rails' %}
#### Notice
<div class="notice notice-warning"><p>We only support https:// for GitHub repos. For other providers please use http:// or git://</p></div>
{% endif %}
