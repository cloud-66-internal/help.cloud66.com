...
When you push code changes to your GitHub repository, you can simply click *Deploy* again to push this code to your servers. You can also set up continuous deployment by adding a Cloud 66 [redeployment hook](/{{page.collection}}/how-to-guides/deployment/redeployment-hook.html) to your GitHub repository.
