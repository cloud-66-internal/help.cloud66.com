...
You can use the [Cloud 66 toolbelt](https://help.cloud66.com/{{page.collection}}/quickstarts/using-cloud66-toolbelt.html) to easily SSH to your servers. Once initialized, the following command can be used:
...
See [toolbelt shortcuts](https://help.cloud66.com/{{page.collection}}/quickstarts/using-cloud66-toolbelt.html), for information on how you can make this even easier.
...
<ol class="list">
<li>Port 22 (SSH) is closed to outside traffic by default - so you need to <a href="https://help.cloud66.com/{{page.collection}}/tutorials/service-network-configuration.html">add a firewall rule to your stack</a> to access it.</li>
...
Toolbelt updates are normally applied automatically in the background, but in some cases these may not work. If so, you may need to <a href="https://help.cloud66.com/{{page.collection}}/quickstarts/using-cloud66-toolbelt.html#update-the-toolbelt">update the toolbelt manually</a>.<br/><br/>
