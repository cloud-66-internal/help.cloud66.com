...
<ol class="list">
<li>Port 22 (SSH) is closed to outside traffic by default - so you need to <a href="/{{page.collection}}/tutorials/service-network-configuration.html">add a firewall rule to your application</a> to access it.</li>
