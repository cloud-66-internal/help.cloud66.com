There are several options to consider when dealing with the infrastructure of a multi-region application. The most challenging part is related to the application - the infrastructure usually caters for how the application is designed to deal with scalability.
