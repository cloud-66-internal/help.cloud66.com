...
2.  [Scale your application servers horizontally]({% if include.product == "skycap" %}/maestro/tutorials/scaling.html{% else %}/{{page.collection}}/tutorials/scaling.html{% endif %}) to the extent that you require.
