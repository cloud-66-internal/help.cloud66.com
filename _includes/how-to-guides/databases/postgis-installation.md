...
Installing through Cloud 66 is as simple as a manifest file entry. Refer to our [Manifest file](/{{ include.product }}/deployment/getting-started-with-manifest-files.html) documentation for more information.
