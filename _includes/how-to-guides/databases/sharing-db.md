...
Firstly, you need to [open your firewall]({% if include.product == "skycap" %}/maestro/tutorials/service-network-configuration.html{% else %}/{{ include.product }}/tutorials/service-network-configuration.html{% endif %}) on the first stack to allow your second stacks web servers to access the database.
