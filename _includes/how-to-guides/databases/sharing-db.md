...
Firstly, you need to [open your firewall]({% if page.collection == "skycap" %}/maestro/how-to-guides/deployment/service-network-configuration.html{% else %}/{{page.collection}}/tutorials/service-network-configuration.html{% endif %}) on the first stack to allow your second stacks web servers to access the database.
