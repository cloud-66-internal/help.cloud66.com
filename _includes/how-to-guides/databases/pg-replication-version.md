...
In this case, you need to upgrade the data and libraries of the master server (9.3) with [pg_upgrade](https://www.postgresql.org/docs/9.4/static/pgupgrade.html) before starting the replication.
