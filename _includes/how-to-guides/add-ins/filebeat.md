<div class="notice notice-danger"><p>This add-in has been deprecated. It will continue working for applications on which it is currently installed, but cannot be installed on new applications.
</p></div>
