...
We'll ask you for your ELK stack endpoint - if you don't have one, you can deploy one using our [EasyDeploy App Store](https://help.cloud66.com/maestro/references/easy-deploy-repos.html).
