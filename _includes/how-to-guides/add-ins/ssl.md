...
Cloud 66 supports _SSL Termination_ on _HAProxy (1.5.x or higher)_, _Amazon Elastic Load Balancer_ and _Hetzner Cloud_. Simply check the option on SSL certificate add on page. This will config your existing load balancer or will apply whenever you create new load balancer.   
