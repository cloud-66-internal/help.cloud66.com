...
$ cx databases resync-slave --stack <application name> --dbtype <database type> <replica server name>
...
$ cx databases resync-slave -s My_Awesome_App my_replica_server_name
$ cx databases resync-slave -s My_Awesome_App --dbtype=postgresql my_replica_server_name
