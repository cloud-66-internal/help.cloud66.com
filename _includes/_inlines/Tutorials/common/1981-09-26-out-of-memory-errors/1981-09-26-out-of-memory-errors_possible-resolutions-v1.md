...
3.  Resize your box to a bigger box either via a new stack, or [vertical scaling](https://help.cloud66.works/{{ include.product }}/stack-management/scaling.html) if available.
