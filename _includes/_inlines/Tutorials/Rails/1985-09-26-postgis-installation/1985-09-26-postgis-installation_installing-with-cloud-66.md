...
{%include _inlines/Tutorials/Rails/1985-09-26-postgis-installation/code_1985-09-26-postgis-installation_installing-with-cloud-1.md  product = include.product %}


For Cloud 66 to install PostGIS, your manifest file should contain the following:


{%include _inlines/Tutorials/Rails/1985-09-26-postgis-installation/code_1985-09-26-postgis-installation_installing-with-cloud-2.md  product = include.product %}


If you would like to specify versions, it should look something like this:


{%include _inlines/Tutorials/Rails/1985-09-26-postgis-installation/code_1985-09-26-postgis-installation_installing-with-cloud-.md  product = include.product %}
