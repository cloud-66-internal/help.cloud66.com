...
{%include _inlines/StackManagement/common/custom-git-repository/code_custom-git-repository_making-changes-to-customconfig-f-v1.md  product = include.product %}
