<!-- usedin: [ _legacy_docker/stack-management/agent-communication-issue.md, _maestro/stack-management/agent-communication-issue.md, _node/stack-management/agent-communication-issue.md, _rails/stack-management/agent-communication-issue.md] -->
