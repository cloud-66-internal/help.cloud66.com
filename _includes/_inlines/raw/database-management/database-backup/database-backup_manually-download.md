...
{%include _inlines/database-backup/code_database-backup_manually-download-curlo.md %}
...
{%include _inlines/database-backup/code_database-backup_manually-download-curlomysq.md %}
...
{%include _inlines/database-backup/code_database-backup_manually-download-catmysqltar.md %}
