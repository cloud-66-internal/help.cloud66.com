...
{%include _inlines/database-backup/code_database-backup_mysql-findpathto.md %}
...
{%include _inlines/database-backup/code_database-backup_mysql-findpathto-2.md %}
...
{%include _inlines/database-backup/code_database-backup_mysql-findpathto-2-3.md %}
...
{%include _inlines/database-backup/code_database-backup_mysql-gzipdpath.md %}
...
{%include _inlines/database-backup/code_database-backup_mysql-export.md %}
...
{%include _inlines/database-backup/code_database-backup_mysql-mysqlu.md %}
...
{%include _inlines/database-backup/code_database-backup_mysql-mysqlu-2.md %}
...
{%include _inlines/database-backup/code_database-backup_mysql-mysqlu-2-3.md %}
...
{%include _inlines/database-backup/code_database-backup_mysql-mysqlu-2-3-4.md %}
