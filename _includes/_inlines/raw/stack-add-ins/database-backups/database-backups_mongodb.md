...
{%include _inlines/database-backups/code_database-backups_mongodb-findpathto.md %}
...
{%include _inlines/database-backups/code_database-backups_mongodb-findpathto-2.md %}
...
{%include _inlines/database-backups/code_database-backups_mongodb-findpathto-2-3.md %}
...
{%include _inlines/database-backups/code_database-backups_mongodb-tarxvfpat.md %}
...
{%include _inlines/database-backups/code_database-backups_mongodb-tarxvfpat-2.md %}
...
{%include _inlines/database-backups/code_database-backups_mongodb-rmrfpath.md %}
...
{%include _inlines/database-backups/code_database-backups_mongodb-mongorestore.md %}
