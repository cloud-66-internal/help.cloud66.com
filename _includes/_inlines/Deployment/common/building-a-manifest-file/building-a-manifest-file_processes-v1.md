...
[Background processes](https://help.cloud66.com/{{ include.product }}/deployment/proc-files.html) can be deployed and managed by Cloud 66. Any process in a `Procfile` will be picked up, deployed and monitored by the system.
...
{%include _inlines/Deployment/common/building-a-manifest-file/code_building-a-manifest-file_processes-oductionp-v1.md  product = include.product %}
