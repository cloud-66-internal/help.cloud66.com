...
Although database migrations only occur on one server, depending on the changes, they could stop deployments on other servers from succeeding. Refer to our page on [controlling your database migrations](https://help.cloud66.works/{{ include.product }}/databases/database-management.html) for more information.
