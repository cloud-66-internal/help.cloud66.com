<!-- usedin: [ _legacy_docker/getting-started/stack-definition.md, _maestro/getting-started/stack-definition.md, _node/getting-started/stack-definition.md, _rails/getting-started/stack-definition.md] -->
