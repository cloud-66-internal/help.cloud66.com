...
To relieve pressure from your application, we recommend that you use background workers to run memory-intensive processes. Cloud 66 makes it easy for you to [control and monitor these processes](https://help.cloud66.works/rails/deployment/proc-files.html), as well as [scale them](https://help.cloud66.works/{{ include.product }}/stack-management/scaling.html) at the click of a button.
