...
{%include _inlines/Deployment/common/getting-started-with-manifest-files/code_getting-started-with-manifest-files_what-is-cors-oduc-v1.md  product = include.product %}
...
{%include _inlines/Deployment/common/getting-started-with-manifest-files/code_getting-started-with-manifest-files_what-is-cors-cxse-v1.md  product = include.product %}
