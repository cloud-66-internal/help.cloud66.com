...
{%include _inlines/Deployment/Rails/sinatra-stacks/code_sinatra-stacks_custom-commands-cxsettingss.md  product = include.product %}
...
{%include _inlines/Deployment/Rails/sinatra-stacks/code_sinatra-stacks_custom-commands-velopment.md  product = include.product %}
