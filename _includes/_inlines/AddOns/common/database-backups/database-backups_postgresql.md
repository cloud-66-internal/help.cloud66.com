...
{%include _inlines/AddOns/common/database-backups/code_database-backups_postgresql-findpathto.md  product = include.product %}
...
{%include _inlines/AddOns/common/database-backups/code_database-backups_postgresql-findpathto-2.md  product = include.product %}
...
{%include _inlines/AddOns/common/database-backups/code_database-backups_postgresql-findpathto-2-3.md  product = include.product %}
...
{%include _inlines/AddOns/common/database-backups/code_database-backups_postgresql-gzipdpath.md  product = include.product %}
...
{%include _inlines/AddOns/common/database-backups/code_database-backups_postgresql-export.md  product = include.product %}
