...
{%include _inlines/AddOns/common/database-backups/code_database-backups_manually-download-curlo-v1.md  product = include.product %}
...
{%include _inlines/AddOns/common/database-backups/code_database-backups_manually-download-curlomysq-v1.md  product = include.product %}
...
{%include _inlines/AddOns/common/database-backups/code_database-backups_manually-download-catmysqltar-v1.md  product = include.product %}
