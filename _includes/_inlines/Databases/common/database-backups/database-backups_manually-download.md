...
{%include _inlines/Databases/common/database-backups/code_database-backups_manually-download-curlo.md %}
...
{%include _inlines/Databases/common/database-backups/code_database-backups_manually-download-curlomysq.md %}
...
{%include _inlines/Databases/common/database-backups/code_database-backups_manually-download-catmysqltar.md %}
