...
{%include _inlines/Databases/common/mongodb-replica-sets/code_mongodb-replica-sets_configure-mongoid-velopments-v1.md  product = include.product %}
...
{%include _inlines/Databases/common/mongodb-replica-sets/code_mongodb-replica-sets_configure-mongoid-velopments-2-v1.md  product = include.product %}
...
{%include _inlines/Databases/common/mongodb-replica-sets/code_mongodb-replica-sets_configure-mongoid-lionmystack-v1.md  product = include.product %}
