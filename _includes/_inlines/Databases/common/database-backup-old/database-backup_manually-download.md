...
{%include _inlines/Databases/common/database-backup/code_database-backup_manually-download-curlo.md  product = include.product %}
...
{%include _inlines/Databases/common/database-backup/code_database-backup_manually-download-curlomysq.md  product = include.product %}
...
{%include _inlines/Databases/common/database-backup/code_database-backup_manually-download-catmysqltar.md  product = include.product %}
