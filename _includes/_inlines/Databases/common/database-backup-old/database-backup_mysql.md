...
{%include _inlines/Databases/common/database-backup/code_database-backup_mysql-findpathto.md  product = include.product %}
...
{%include _inlines/Databases/common/database-backup/code_database-backup_mysql-findpathto-2.md  product = include.product %}
...
{%include _inlines/Databases/common/database-backup/code_database-backup_mysql-findpathto-2-3.md  product = include.product %}
...
{%include _inlines/Databases/common/database-backup/code_database-backup_mysql-gzipdpath.md  product = include.product %}
...
{%include _inlines/Databases/common/database-backup/code_database-backup_mysql-export.md  product = include.product %}
...
{%include _inlines/Databases/common/database-backup/code_database-backup_mysql-mysqlu.md  product = include.product %}
...
{%include _inlines/Databases/common/database-backup/code_database-backup_mysql-mysqlu-2.md  product = include.product %}
...
{%include _inlines/Databases/common/database-backup/code_database-backup_mysql-mysqlu-2-3.md  product = include.product %}
...
{%include _inlines/Databases/common/database-backup/code_database-backup_mysql-mysqlu-2-3-4.md  product = include.product %}
