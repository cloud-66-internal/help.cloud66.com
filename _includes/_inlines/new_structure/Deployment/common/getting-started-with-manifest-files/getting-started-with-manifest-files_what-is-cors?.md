...
{%include _inlines/getting-started-with-manifest-files/code_getting-started-with-manifest-files_what-is-cors?-oduc.md %}
...
{%include _inlines/getting-started-with-manifest-files/code_getting-started-with-manifest-files_what-is-cors?-cxse.md %}
