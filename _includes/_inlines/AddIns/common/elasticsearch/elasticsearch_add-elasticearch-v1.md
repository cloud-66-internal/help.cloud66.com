<!-- usedin: [ _legacy_docker/AddIns/elasticsearch-v1.md, _maestro/AddIns/elasticsearch-v1.md, _node/addins/elasticsearch-v1.md, _rails/AddIns/elasticsearch-v1.md] -->
