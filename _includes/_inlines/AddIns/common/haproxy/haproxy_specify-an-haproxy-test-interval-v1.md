...
{%include _inlines/AddIns/common/haproxy/code_haproxy_specify-an-haproxy-test-interval-verweb-v1.md  product = include.product %}
...
{%include _inlines/AddIns/common/haproxy/code_haproxy_specify-an-haproxy-test-interval-verweb-2-v1.md  product = include.product %}
