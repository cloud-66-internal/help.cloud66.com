...
*Finance users* only have access to your *Payment* page, and can change billing information. They will automatically receive email payment notifications (successful and unsuccessful payments), but have no access rights to applications.

#### Note
<div class="notice"><p>A finance user still needs to create a standard Cloud 66 account before they and will be prompted via email to do so if they have not already.</p></div>

You can also opt to *cc* other email addresses whenever invoices are sent to you. To do this:
