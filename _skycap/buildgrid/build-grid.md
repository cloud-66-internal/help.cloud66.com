...
{% include _inlines/Deployment/common/build-grid/build-grid_what-is-buildgrid-v1.md  product = page.collection %}
{% include _inlines/Deployment/common/build-grid/build-grid_how-to-use-buildgrid-v1.md  product = page.collection %}
{% include _inlines/Deployment/common/build-grid/build-grid_envoironment-variables-in-buildgrid-v1.md  product = page.collection %}
{% include _inlines/Deployment/common/build-grid/build-grid_build-and-publish-v1.md  product = page.collection %}