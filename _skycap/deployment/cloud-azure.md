...
<a name="1"></a>{% include _inlines/Deployment/common/cloud-azure/cloud-azure_contents.md  product = product %}
<a name="2"></a>{% include _inlines/Deployment/common/cloud-azure/cloud-azure_about-using-microsoft-azure-cloud.md  product = product %}
<a name="3"></a>{% include _inlines/Deployment/common/cloud-azure/cloud-azure_generating-a-management-certificate.md  product = product %}
<a name="4"></a>{% include _inlines/Deployment/common/cloud-azure/cloud-azure_using-your-management-certificate.md  product = product %}
<a name="5"></a>{% include _inlines/Deployment/common/cloud-azure/cloud-azure_notice.md  product = product %}