...
<a name="1"></a>{% include _inlines/Teams/General/team-accounts/team-accounts_about-using-team-accounts-v1.md  product = product %}
<a name="2"></a>{% include _inlines/Teams/General/team-accounts/team-accounts_account-user-roles-and-permissions-v1.md  product = product %}
<a name="3"></a>{% include _inlines/Teams/General/team-accounts/team-accounts_add-a-team-member-v1.md  product = product %}
<a name="4"></a>{% include _inlines/Teams/General/team-accounts/team-accounts_switch-organizations-v1.md  product = product %}
<a name="5"></a>{% include _inlines/Teams/General/team-accounts/team-accounts_leave-a-team-v1.md  product = product %}
<a name="6"></a>{% include _inlines/Teams/General/team-accounts/team-accounts_add-a-role-v1.md  product = product %}
<a name="7"></a>{% include _inlines/Teams/General/team-accounts/team-accounts_pricing-v1.md  product = product %}
<a name="8"></a>{% include _inlines/Teams/General/team-accounts/team-accounts_-v1.md  product = product %}