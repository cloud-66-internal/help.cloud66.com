...
We will be looking at some simple examples in this tutorial, but for a deeper understanding please read the [full reference guide](/{{page.collection}}/references/deploy-hooks-syntax.html).
...
10. [***before_z***](/{{page.collection}}/references/deploy-hooks-syntax.html#beforez)
11. Application framework is installed 
12. ***after_checkout*** 
13. ***after_bundle*** 
14. ***after_symlink*** 
15. [***after_z***](/{{page.collection}}/references/deploy-hooks-syntax.html#afterz)
...
See the available [hook points](/{{page.collection}}/references/deploy-hooks-syntax.html#hook-points) and [fields](/{{page.collection}}/references/deploy-hooks-syntax.html#hook-fields) for more ways to customize this.
