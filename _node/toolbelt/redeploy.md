...
<a name="1"></a>{% include _inlines/Toolbelt/common/redeploy/redeploy_redeploy-your-stack.md  product = product %}
<a name="2"></a>{% include _inlines/Toolbelt/common/redeploy/redeploy_usage.md  product = product %}
<a name="3"></a>{% include _inlines/Toolbelt/common/redeploy/redeploy_parameters.md  product = product %}
<a name="4"></a>{% include _inlines/Toolbelt/common/redeploy/redeploy_examples.md  product = product %}