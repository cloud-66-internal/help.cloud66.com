...
<a name="1"></a>{% include _inlines/Toolbelt/common/upload/upload_upload-v1.md  product = product %}
<a name="2"></a>{% include _inlines/Toolbelt/common/upload/upload_usage-v1.md  product = product %}
<a name="3"></a>{% include _inlines/Toolbelt/common/upload/upload_parameters-v1.md  product = product %}
<a name="4"></a>{% include _inlines/Toolbelt/common/upload/upload_example-v1.md  product = product %}