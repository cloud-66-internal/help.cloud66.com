...
<a name="1"></a>{% include _inlines/Toolbelt/common/settings/settings_list-your-stack-settings-v1.md  product = product %}
<a name="2"></a>{% include _inlines/Toolbelt/common/settings/settings_usage-1-v1.md  product = product %}
<a name="3"></a>{% include _inlines/Toolbelt/common/settings/settings_parameters-1-v1.md  product = product %}
<a name="4"></a>{% include _inlines/Toolbelt/common/settings/settings_example-1-v1.md  product = product %}
<a name="5"></a>{% include _inlines/Toolbelt/common/settings/settings_set-your-stack-settings-v1.md  product = product %}
<a name="6"></a>{% include _inlines/Toolbelt/common/settings/settings_usage-v1.md  product = product %}
<a name="7"></a>{% include _inlines/Toolbelt/common/settings/settings_parameters-v1.md  product = product %}
<a name="8"></a>{% include _inlines/Toolbelt/common/settings/settings_example-v1.md  product = product %}
<a name="9"></a>{% include _inlines/Toolbelt/common/settings/settings_settings-variables-v1.md  product = product %}